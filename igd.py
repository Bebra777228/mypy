...
git clone 'https://huggingface.co/Rejekts/project/resolve/main/project-main.zip' -O '/content/project-main.zip' && unzip -n 'project-main.zip' -d /content/drive/MyDrive
